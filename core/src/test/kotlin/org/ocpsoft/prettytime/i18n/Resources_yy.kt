...
class Resources_yy : ListResourceBundle() {
  ...
  companion object {
    private val OBJECTS = arrayOf(
        ...
        arrayOf("DayFutureSingularName", "futureday"),
        arrayOf("DayFuturePluralName", "futuredays"),
        arrayOf("DayPastSingularName", "pastday"),
        arrayOf("DayPastPluralName", "pastdays"),
        ...
        arrayOf("HourFutureSingularName", "hour"),
        arrayOf("HourFuturePluralName", ""),
        arrayOf("HourPastSingularName", ""),
